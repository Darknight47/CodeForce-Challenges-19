...
---------------------------------------------------- Link for the challenge: https://codeforces.com/contest/2093/problem/B ----------------------------------------------------
...
You are given a positive integer n that does not contain leading zeros. 
You can remove any number of digits from the number n (including none) so that the remaining number contains at least one digit and is strictly greater than zero. 
The remaining digits cannot be rearranged. As a result, you may end up with a number that has leading zeros.
...
The only line of each test case contains a positive integer n (1 ≤ n < 10^100) without leading zeros.
