...
Output
For each test case, in the first line output m (0 ≤ m ≤ 10^5) — the minimum number of operations required. 
It's guaranteed that the objective is always achievable in at most 105 operations under the constraints of the problem.
